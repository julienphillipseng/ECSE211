...
public class OdometerData {
	...
	private volatile double line;
	
	private volatile double colorR;
	private volatile double colorG;
	private volatile double colorB;
	...
	/**
	 * This method returns the RGB, light intensity, and distance values known by the odometer.
	 * @return an array containing last measured RGB intensities, light intensity, and distance:<br>
	 * Arr[0] = distance<br>
			Arr[1] = line<br>
			Arr[2] = colorR<br>
			Arr[3] = colorG<br>
	...
	/**
	 * Overrides distance stored by the odometer
	 * @param distance
	 */
	...
	/**
	 * Overrides light intensity stored by the Odometer
	 * @param light
	 */
	public void setLine (double light) {
		lock.lock();
		isReseting = true;
		try {
			this.line = light;
	...
	/**
	 * Overrides RGB values stored by the Odometer
	 * @param light
	 */
